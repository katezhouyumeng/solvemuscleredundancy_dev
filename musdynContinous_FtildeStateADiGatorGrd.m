...
Tdiff.dV = zeros(size(Tdiff.f,1),220);
for cadaforcount1 = 1:5
    ...
    cada1f3 = 43;
    cada1tf2 = ones(43,1);
    cada1tf1 = sparse(Gator1Data.Index12,Gator1Data.Index13,cada1tf2(Gator1Data.Index11),43,43);
    cada1f4dV = full(cada1f2dV*cada1tf1);
    cada1f4 = sum(cada1f2,2);
    cada1td1 = zeros(size(aT.f,1),5);
    ...
    cada1td1 = zeros(size(cada1f4dV,1),48);
...
cada1td1 = zeros(size(Tdiff.f,1),349);
...
cada1td1 = zeros(size(dadt.f,1),129);
...
cada1f1 = e.f.^2;
cada1tf2 = ones(43,1);
cada1tf1 = sparse(Gator1Data.Index21,Gator1Data.Index22,cada1tf2(Gator1Data.Index20),43,43);
cada1f2dV = full(cada1f1dV*cada1tf1);
cada1f2 = sum(cada1f1,2);
cada1f3dV = 2.*aT.f.^(2-1).*aT.dV;
cada1f3 = aT.f.^2;
cada1tf2 = ones(5,1);
cada1tf1 = zeros(5,5);
cada1tf1(Gator1Data.Index24) = cada1tf2(Gator1Data.Index23);
cada1f4dV = cada1f3dV*cada1tf1;
cada1f4 = sum(cada1f3,2);
cada1f5dV = w1.f.*cada1f4dV;
cada1f5 = w1.f*cada1f4;
cada1td1 = zeros(size(cada1f2dV,1),48);
cada1td1(:,Gator1Data.Index25) = cada1f2dV;
cada1td1(:,Gator1Data.Index26) = cada1td1(:,Gator1Data.Index26) + cada1f5dV;
cada1f6dV = cada1td1;
...
cada1f8 = cada1f7.^2;
cada1tf2 = ones(43,1);
cada1tf1 = sparse(Gator1Data.Index28,Gator1Data.Index29,cada1tf2(Gator1Data.Index27),43,43);
cada1f9dV = full(cada1f8dV*cada1tf1);
cada1f9 = sum(cada1f8,2);
cada1f10dV = w2.f.*cada1f9dV;
cada1f10 = w2.f*cada1f9;
cada1td1 = zeros(size(cada1f6dV,1),91);
...
cada1td1 = zeros(size(d1.dV,1),86);
...
cada1td1 = zeros(size(d2.dV,1),86);
...
cada1f6 = cada1f2.*cada1f5;
cada1td1 = zeros(size(cada1f1dV,1),86);
cada1td1(:,Gator1Data.Index1) = cada1f1dV./cada1f6;
cada1td1(:,Gator1Data.Index2) = cada1td1(:,Gator1Data.Index2) + -cada1f1./cada1f6.^2.*cada1f6dV;
vT.dV = cada1td1;
...
cada1td1 = zeros(size(cada1f1dV,1),129);
